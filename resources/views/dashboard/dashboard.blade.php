    ...
    <div class="">
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    @if (auth()->user()->role != '1')
                        @if (auth()->user()->role != '4')
                            <li>
                                <a href="/bendahara"
                                    class="flex items-center p-3  rounded-lg text-white hover:bg-white/10">
                                    <svg aria-hidden="true"
                                        class="flex-shrink-0 w-6 h-6 text-white transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white"
                                        fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path
        ...
        <div class="p-4 xl:ml-80 h-max">
            <div class="p-4">
                    ...
                    <div class="flex items-center justify-center rounded mb-4">
                        <div id="alert-additional-content-5"
                            ...
                            <div class="mt-2 mb-4 text-sm text-white dark:text-gray-300">
                                Halo, Ultimacrews! Jangan lupa untuk datang di Rapat Pleno April pada 3 Mei 2023 pukul
                                18.30
                                WIB di Lecture Hall!
                ...
                @endif
                <div
                    class="grid grid-cols-none md:grid-cols-2 gap-4 {{ auth()->user()->role != '2' ? 'md:my-[9.1rem]' : 'md:mb-6' }}">
                    <div
                    ...
                    <form action="{{ route('dashboard') }}" method="post">
                        <div
                            ...
                            <div class="relative w-full min-w-[200px] h-11">
                                <input for="current_password" name="current_password" type="password"
                ...
                @if (auth()->user()->role == 2)
                    <div class="bg-clip-border rounded-xl bg-white text-gray-700 shadow-md p-4 gap-4 mb-4 w-full">
                        <div
                            ...
                            <h3 class="block antialiased tracking-normal leading-snug text-lg font-medium text-white">
                                Inbox
                            </h3>
                        </div>
                        <div class="flex flex-col gap-4">
                            @foreach ($msgs as $msg)
                                @if ($msg->receiver == auth()->user()->name)
                                    <a href="#"
                                        ...
                                        @if ($msg->anonymous == 0)
                                            <p class="mb-2 font-bold tracking-tight text-gray-900 dark:text-white">From
                                                :
                                                {{ $msg->sender }}</p>
                                        @else
                                            <p class="mb-2 font-bold tracking-tight text-gray-900 dark:text-white">From
                            ...
                            <a href="#"
                                class="block w-fullm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                                <p class="mb-2 font-bold tracking-tight text-gray-900 dark:text-white">From : IT &
                                    Software
                                    Development Gen XII</>
