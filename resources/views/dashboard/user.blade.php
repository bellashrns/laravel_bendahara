    ...
    <div class="p-4 xl:ml-80">
        <div class="p-4"> 
            <div class="flex items-center justify-center rounded mb-4">
                <div id="alert-additional-content-5" class="p-4 border border-gray-300 rounded-lg bg-gradient-to-br from-[#011F39] to-[#629FD4] dark:border-gray-600 dark:bg-gray-800 w-full" role="alert">
        ...
        <div class="flex items-center justify-center rounded mb-4">
            <div class="bg-clip-border rounded-xl bg-white text-gray-700 shadow-md p-4 gap-4 mb-4 w-full">
                ...
                @foreach ($users as $user)
                    @if ($user->role == '2')
                    <a href="#" class="block w-sm-1/5 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"> 
                        <img src="{{url('/images/profile.jpg')}}" alt="Image" class="rounded-t-lg h-60 w-60"/>
                        <!-- @if ($user->image)
